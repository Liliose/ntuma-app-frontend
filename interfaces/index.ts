...
export enum EVENT_NAMES_ENUM {
  ...
  REMOVE_AGENTS_EARNING_TYPE = 'REMOVE_AGENTS_EARNING_TYPE',
  ...
  REMOVE_AGENTS_MARKET_SUBSCRIPTION = 'REMOVE_AGENTS_MARKET_SUBSCRIPTION',
  ...
  REMOVE_AGENTS_WALLET = 'REMOVE_AGENTS_WALLET',
  ...
  REMOVE_DISH_PRODUCTS = 'REMOVE_DISH_PRODUCTS',
  ...
  REMOVE_RIDERS_WALLET = 'REMOVE_RIDERS_WALLET',
  ...
  REMOVE_SUPPLIERS_PAYMENT_DETAILS = 'REMOVE_SUPPLIERS_PAYMENT_DETAILS',
